...
udocker run -p 30000:30000 -v $MODEL_ARG:/sgl-workspace/llm $CONTAINER_NAME python3 -m sglang.launch_server  --model-path /sgl-workspace/llm --host 0.0.0.0 --port 30000 --disable-cuda-graph --mem-fraction-static 0.7
