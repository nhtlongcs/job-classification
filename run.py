...
# except:
df_result = df_subset.progress_apply(lambda row: pd.Series(get_query_results(pipeline, row["final_description"], top_k=top_k)), axis=1)
...
save_results(df_result, f"top_k_prediction/classification_top_{top_k}_{model_name}.csv")
