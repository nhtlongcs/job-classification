...
def main():
    ...
    df = parse_log_to_dataframe(
        [
            [
                "artifacts/archive/logs/mistral_log.txt",
                "artifacts/archive/logs/mistral_log_reversed.txt",
                "artifacts/archive/logs/mistral_log_missing.txt",
            ],
            [
                "artifacts/archive/logs/gemma2_log.txt",
                "artifacts/archive/logs/gemma2_log_reversed.txt",
            ],
            [
                "artifacts/archive/logs/gemma2_27b_log.txt",
                "artifacts/archive/logs/gemma2_27b_log_reversed.txt",
            ],
        ],
        [
            "mistral_nemo",
    ...
    rich.print("[[green]result saved to artifacts/archive/results/classification.csv[/green]]")
