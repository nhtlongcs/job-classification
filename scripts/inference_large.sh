...
QWEN_CFG="configs/qwen_bm25_mistralnemo.ini"
ICL_CFG="configs/icl_bm25_mistralnemo.ini"
GEMMA2_CFG="configs/gemma2_bm25_mistralnemo.ini"

STELLA_CFG_GEMMA="configs/stella_bm25_gemma2.ini"
QWEN_CFG_GEMMA="configs/qwen_bm25_gemma2.ini"
ICL_CFG_GEMMA="configs/icl_bm25_gemma2.ini"
...
python src/retrieve.py -c $QWEN_CFG
python src/retrieve.py -c $ICL_CFG
python src/retrieve.py -c $GEMMA2_CFG

python src/rerank.py -c $STELLA_CFG
python src/rerank.py -c $QWEN_CFG
python src/rerank.py -c $ICL_CFG
python src/rerank.py -c $GEMMA2_CFG

python src/inference_batch.py -c $STELLA_CFG 
python src/inference_batch.py -c $QWEN_CFG 
python src/inference_batch.py -c $ICL_CFG 
...
python src/submission.py -c $QWEN_CFG_GEMMA -o artifacts/results_qwen_gemma2/
python src/submission.py -c $ICL_CFG_GEMMA -o artifacts/results_icl_gemma2/
...
python src/submission.py -c $QWEN_CFG-o artifacts/results_qwen_mistral/
python src/submission.py -c $ICL_CFG-o artifacts/results_icl_mistral/
...
python merge.py --ensemble_files artifacts/results_stella_gemma2/classification.csv \
                artifacts/results_qwen_gemma2/classification.csv \
                artifacts/results_icl_gemma2/classification.csv \
                artifacts/results_gemma2_gemma2/classification.csv \
                artifacts/results_stella_mistral/classification.csv \
                artifacts/results_qwen_mistral/classification.csv \
                artifacts/results_icl_mistral/classification.csv \
